...
const Navbar = () => {
  ...
  return (
    <div className="w-full flex justify-between items-center p-4 md:p-6 lg:p-8 z-50 h-28 relative">
      ...
      <div
        className={`fixed inset-0 bg-black text-white flex flex-col items-center justify-center gap-6 text-[18px] font-[500] transition-all duration-300 ease-in-out ${
